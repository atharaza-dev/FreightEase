                ...
                <div class=" py-4 md:py-7 px-4 md:px-8 xl:px-10">
                    ...
                    <section class="mx-auto w-full max-w-7xl px-2 pb-2 font1 text-white">
                        ...
                        <div class="flex flex-col space-y-4 items-end md:justify-between md:space-y-0">
                            ...
                            <Link to="/add-contact" class="rounded-md bg-green-400 px-3 py-2 text-sm font-semibold text-gray-600 shadow-sm hover:bg-green-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black">
                                <span><i class="fa-solid fa-plus text-gray-600 mr-2"></i>Manage Orders</span>
                            </Link>
