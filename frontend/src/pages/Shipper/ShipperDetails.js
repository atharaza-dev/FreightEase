                        ...
                        <div class="mx-auto w-full max-w-[700px] py-12">
                            ...
                            <form class="py-4 px-9">
                                <div class="relative mb-4">
                                    ...
                                    <input type="text" class="w-full bg-gray-100 rounded-sm border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                </div>
                                <div class="relative mb-4">
                                ...
                                <div class="relative mb-4">
                                    <button class="text-white w-full bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded text-md my-3">Save</button>
