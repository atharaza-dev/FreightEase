                ...
                <div class="mainForm lg:grid lg:min-h-screen lg:grid-cols-12">
                    ...
                    >
                        <div class="max-w-xl lg:max-w-3xl">
                            ...
                            <Link
                                class="inline-flex items-center gap-2 mr-4  rounded border border-indigo-600 px-8 py-3 text-indigo-600 hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
                            ...
                            <Link
                                class="inline-flex items-center gap-2 mt-4 rounded border border-indigo-600 bg-indigo-600 px-8 py-3 text-white active:text-indigo-500"
                            ...
                            <form method="POST" class="mt-8 grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
                                    <button onClick={vendorRegistrationClick} class="text-white bg-indigo-800 border-0 py-3 px-8 focus:outline-none hover:bg-indigo-600 rounded text-md">
                                        Create account
                                    </button>
                                    <p class="mt-4 text-sm text-gray-500 sm:mt-0">
                                        Already have an account?
                                        <Link to="/vendor-login" class="text-indigo-500 underline px-2">Log in</Link>
                                    </p>
                                </div>
                            </form>
                        </div>
