                ...
                <div className="mainForm lg:grid lg:min-h-screen lg:grid-cols-12">
                    ...
                    >
                        <div className="max-w-xl lg:max-w-3xl">
                            ...
                            <Link
                                className="inline-flex items-center gap-2 mt-4 mr-4 rounded border border-blue-800 bg-primColor1 px-8 py-3 text-white"
                                to="/shipper-login"
                            >
                            ...
                            <Link
                                className="inline-flex items-center gap-2 rounded border border-blue-800 px-8 py-3 text-indigo-600 hover:bg-primColor1 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
                                to="/vendor-login"
                            >
                            ...
                            <form method="POST" className="mt-8 grid grid-cols-6 gap-6 fontAlt">
                                ...
                                <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                                    <button onClick={loginClickHandler} class="text-white bg-primColor1 border-0 py-3 px-8 focus:outline-none hover:bg-blue-600 rounded text-md">
                                        Sign In
                                    </button>
