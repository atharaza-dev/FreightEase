                ...
                <div className="mainForm lg:grid lg:min-h-screen lg:grid-cols-12">
                    ...
                    >
                        <div className="max-w-xl lg:max-w-3xl">
                            ...
                            <Link
                                className="inline-flex items-center gap-2 mt-4 mr-4 rounded border border-indigo-600 bg-indigo-600 px-8 py-3 text-white"
                                to="/shipper-login"
                            >
                                ...
                                <span className="text-sm txt-font ltrspace"> Customer </span>
                            </Link>
                            ...
                            <form method="POST" className="mt-8 grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6">
                                    ...
                                    <input value={password} onChange={passChangeHandler} type="text" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                </div>

                                <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                                    <button onClick={loginClickHandler} class="text-white bg-indigo-800 border-0 py-3 px-8 focus:outline-none hover:bg-indigo-600 rounded text-md">
                                        Sign In
                                    </button>
