...
function AboutPage() {
    ...
    return (
        <>
            ...
            <section class="">
                <div class="mx-auto max-w-screen-xl px-4 p-12 sm:px-6 md:pt-16 lg:px-8">
                    <div class="mx-auto max-w-5xl text-center">
                        <h2 class="display-5 fontAlt font-semibold mb-4">
                            Our Unmatched Statistics
                        </h2>
                        <p class="w-full text-base">FreightEase provides invaluable insights into the performance of our transportation, freight, and logistics services. Discover data-driven solutions to optimize your supply chain and streamline operations.</p>
                    </div>
            ...
            <section class="bg-white">
                <div class="container px-24 py-40 mx-auto">
                    <div class="mx-auto max-w-5xl text-center">
                        <h2 class="display-5 fontAlt font-semibold mb-4">
                            Our Executive Team
                        </h2>
            ...
            <div class="my-10 mx-auto flex max-w-xl flex-col rounded-xl border bg-gray-700 py-10 px-4 text-center sm:px-10 lg:max-w-screen-lg lg:flex-row lg:text-left">
                <div class="mx-auto w-[15rem] max-w-full lg:mx-0 lg:w-[40rem]">
                    <img class="h-full w-full object-contain" src="https://mir-s3-cdn-cf.behance.net/project_modules/disp/4fa0e724015357.5632ca672052c.png" alt="" />
                </div>
                <div class="lg:pl-10">
                    <h1 class="mt-8 text-4xl font-bold text-white md:text-5xl md:leading-snug">
                        Startup Branding <br class="hidden sm:block" />
                        In a Nutshell
                    </h1>
                    <p class="mt-4 text-xl text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis numquam qui ratione. Ullam excepturi repellendus obcaecati recusandae laudantium!</p>
                    <div class="mt-8 flex flex-col rounded-md border bg-white sm:flex-row">
                        <input class="m-2 h-12 rounded-md px-4 text-gray-500 focus:outline-none focus:ring focus:ring-red-400 sm:w-full" placeholder="Enter your email" type="email" name="email" />
