                    ...
                    <div class="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
                        ...
                        <div class="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8">
                            ...
                            <form action="https://formspree.io/f/moqgknoe" method='POST'>
                                ...
                                <div class="mt-4 grid">
                                    <button onClick={sendEmailHandler} type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Send inquiry</button>
                                </div>
