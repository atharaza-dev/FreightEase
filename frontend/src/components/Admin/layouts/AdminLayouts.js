    ...
    return (
        <>
            <section class="min-h-screen">
                ...
                <aside class="fixed top-0 left-0 fontAlt bg-white z-50 left-0 pb-8 item-center justify-center overflow-x-hidden overflow-y-auto flex flex-col w-64 h-screen px-4 py-4 shadow-sm border-r border-gray-250 ">
                    ...
                    <div class="flex flex-col justify-between flex-1">
                        <nav>
                            ...
                            <Link to='/admin' class="flex items-center pl-4 py-2 mt-8 text-gray-600 transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                            ...
                            <Link to='vendors' class="flex items-center pl-4 py-2 mt-3 text-gray-600 transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                                <i class="fa-duotone fa-truck-fast fa-lg text-primColor1"></i>
                                <span class="ml-4 font-medium">Vendor Connect</span>
                            </Link>
                            ...
                            <Link to='shippers' class="flex items-center pl-4 py-2 mt-3 text-gray-600 transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                                <i class="fa-duotone fa-box fa-lg text-primColor1"></i>
                                <span class="ml-4 font-medium">Shipper Connect</span>
                            </Link>
                            ...
                            <Link to='revenue' class="flex items-center pl-4 py-2 mt-3 text-gray-600 transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                                <i class="fa-duotone fa-sack-dollar fa-lg text-primColor1"></i>
                            ...
                            <Link to='invoice' class="flex items-center pl-4 py-2 mt-3 text-gray-600 transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                                <i class="fa-duotone fa-file-invoice fa-lg text-primColor1"></i>
                ...
                <header className="hea fixed top-2 left-0 ml-6 md:left-64 right-3 mr-6 flex items-center justify-between h-20 bg-white px-4 md:px-8 xl:px-64 rounded shadow-sm border-1 border-gray-250">
                    <h3 className='fontAlt text-2xl font-semibold '>Welcome, Athar Raza</h3>
                    <div className="flex items-center gap-x-6">
                        ...
                        <div className="flex relative items-center">
                            <div className="mr-3 justify-end">
                                <p className="text-sm font-semibold text-end fontAlt">Athar Raza</p>
                                <p className="txtsize text-gray-600 text-end fontAlt">ADMIN</p>
                            </div>
