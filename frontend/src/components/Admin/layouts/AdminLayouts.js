...
function AdminLayouts() {
    return (
        <>
            <header className='flex flex-column w-64 mr-4'>

                <aside class="menu">

                </aside>

                <aside class=" sidebar fixed z-50 w-64 pt-4 flex flex-col px-4 py-8 bg-gray-800 border-r rtl:border-r-0 rtl:border-l dark:border-gray-700">
                    <Link href="#">
