            ...
            <div class="w-full mt-20 flex items-center justify-center bg-gray-900 rounded-t-full">
                <div class="md:w-2/3 w-full px-4 text-white flex flex-col">
                    ...
                    <div class="w-full text-7xl font-bold">
                        <h1 class="w-full fontH1 md:w-2/3">Empower freight solutions with us</h1>
                    </div>
                    <div class="flex mt-8 flex-col md:flex-row md:justify-between">
                        <p class="w-full md:w-2/3 text-gray-400">FreightEase is the city's leading solution, setting new standards for logistics and transportation excellence. It empowers freight and logistics services to excel.
                            Click to Generate Quote</p>
                        <div class="w-44 pt-6 md:pt-0">
                            <Link to='/error' class="bg-red-500 justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">Get Started</Link>
                        </div>
                    </div>
                    <div class="flex flex-col">
                        <div class="flex mt-24 mb-12 flex-row justify-between justify-center items-center">
                            <div class="">
                                <img src={logo} alt="err" className='w-44' />
                            </div>
                            <Link to='/error' class="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">About</Link>
                            <Link to='/error' class="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Services</Link>
                            {/* < class="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Portfolio</  a> */}
                            <Link to='/error' class="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Contact</Link>
                            <div class="flex flex-row space-x-8 items-center justify-between">
                                ...
                                <Link to='www.instagram.com/atharaza.dev'>
                        ...
                        <p class="w-full text-center my-12 text-gray-600">Copyright © 2024 FreightEase - Developed by @atharaza.dev</p>
                    </div>
                </div>
            </div>
        </>
